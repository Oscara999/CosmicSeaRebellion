...
public class Mision2 : MonoBehaviour
{
    ...
    public void CheckAnswer(int buttonIndex)
    {
        if (buttonIndex == correctAnswer)
        {
            ...
            misionManager.CorrectAnswer("Mision_2");
    ...
    private void GenerateQuestion()
    {
        ...
        questionText.text = string.Format("¿Podrias ayudarme a recolecar a {0} - {1} gallinas que han escapado? ", numberA, numberB); // Puedes personalizar el formato de la pregunta según tus necesidades
