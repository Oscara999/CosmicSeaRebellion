...
public class Mision1 : MonoBehaviour
{
    ...
    public void CheckAnswer(int buttonIndex)
    {
        if (buttonIndex == correctAnswer)
        {
            ...
            misionManager.CorrectAnswer("Mision_1");
    ...
    {
        numberA = Random.Range(1, 4); // Rango de números aleatorios para A (puedes ajustarlos según tus necesidades)
    ...
    private void GenerateQuestion()
    {
        ...
        questionText.text = string.Format("¿Podrias ayudarme a eliminar a {0} + {1} soldados? ", numberA, numberB); // Puedes personalizar el formato de la pregunta según tus necesidades
