...
public class Mover : MonoBehaviour {
    ...
    [SerializeField] public float colliderThickness = 0.48f;
    [SerializeField] public Vector3 colliderOffset = Vector3.zero;
    [SerializeField] float colliderHeightNormal = 1.76f;
    [SerializeField] float colliderHeightCrouched = 1.12f;
    public float test;
    ...
    public Vector3 currentGroundAdjustmentVelocity = Vector3.zero;
    ...
    public void ChangeCollisionDimensions(bool validation)
    {
        if (validation)
        {
           // RecalculateColliderDimensions(colliderHeightCrouched);
        }
        else
        {
           // RecalculateColliderDimensions(colliderHeightNormal);
        }
    }
